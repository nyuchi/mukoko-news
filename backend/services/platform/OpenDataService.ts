  ...
  accessMethods: [
    {
      name: 'REST API',
      type: 'api',
      url: 'https://mukoko-news-backend.nyuchi.workers.dev/api/v1/open-data',
    ...
    },
    {
      name: 'RSS/Atom Feeds',
      type: 'feed',
      url: 'https://mukoko-news-backend.nyuchi.workers.dev/feeds',
    ...
    },
    {
      name: 'Bulk Export',
      type: 'export',
      url: 'https://mukoko-news-backend.nyuchi.workers.dev/api/v1/open-data/export',
